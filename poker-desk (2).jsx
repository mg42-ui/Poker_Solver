...
function createSim(hero, board, opponents, seed, oneCard) {
...
export default function PokerDesk() {
  ...
  useEffect(() => {
    ...
    const engine = createSim(hole, knownBoard, opponents, seed);
    ...
    const engineOne = twoToCome ? createSim(hole, knownBoard, opponents, seed + 5, true) : null;
